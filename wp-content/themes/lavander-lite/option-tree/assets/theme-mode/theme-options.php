...
So be sure that you are always installin the file called <strong>"LAVANDER.ZIP"</strong>

<br><br>

Once the theme is uploaded, you need to activate it. Go to Appearance > Themes and activate Lavander WordPress Theme. After the theme is activated, you need to install the required plugins for some extra functionality (Instagram, Contact Form and Shortcodes
...
<ul>
 	<li>Install the Lavander WordPress Theme</li>
 	...
 	<li>You might also have to set Menus locations under Appearance -> Menu -> Menu Settings</li>
        ...
        array(
          ...
          'content'   => 'For exact settings for all 6 live demos please check the other document included in the documentation, named: Lavander-HOW-TO-SET-DEMOS
<br><br>
TIMEOUT ERROR
<br><br>
...
<strong>Instagram block - </strong>simply add the title, your instagram username and link to your instagram profile. Detailed instructions on how to connect the plugin with your instagram account are available in the plugin itself at Settings - > Alpine:Instagram    -> General.'
        ...
        array(
          ...
          'content'   => '<strong>Main Theme Color</strong> - color that is set throghout the Theme (red is default color for Lavander Theme). Once you change the color please not that not all aspects of the site will change (some color will still be red). This is because on some parts of the Theme <strong>shortcodes</strong> are used. You need to change this manually as it gives you much more
<br><br>
...
<br><br>
<strong>Parse error: syntax error, unexpected $end in …/wp-content/themes/Lavander/admin/theme-options.php on line 1</strong>
<br><br>
This happens if you install the Theme via FTP and the transfer type is not set to <strong>binary</strong>. So set the transfer type to binary as can be <a href="http://premiumcoding.com/wp-content/uploads/2014/08/ftp-upload-opus.jpg">seen on this link</a>.'
        ...
        array(
          ...
          'content'   => 'Lavander uses several different image sizes which are listed below:
<ul>
 	<li>Blog 1160 x 770 (fullwidth), 760 x 500 (with sidebar)</li>
 	<li>Upper three posts - 640 x 400</li>
 	<li>About us avatar - 300 x 300</li>
...
<ul>
 	...
 	<li>Go to themeforest, to your downloads page, this link precisely: <strong>http://themeforest.net/downloads</strong> and download Lavander theme</li>
...
<li>Sidebar under header fullwidth</li>
      ...
      array(
        'id'          => 'logo_position',
        'label'       => 'Where do you wish to display your lgog?',
...
Instagram block above the footer can display your latest images from your Instagram. It\'s not connected to the Instagram in the sidebar, you can set that under Appearance -&gt; Widgets.',
      ...
      array(
        ...
        'std'         => 'http://instagram.com/lavanderpmc',
        'type'        => 'text',
        'section'     => 'instagram_block',
        'rows'        => '',
        'post_type'   => '',
...
<ul><li>
<a href="http://lavander.premiumcoding.com/wp-content/uploads/2016/12/Lavander-WordPress-Theme-Documentation-1.pdf" target="_blank"><b>Documentation</b></a></li>
</ul>
