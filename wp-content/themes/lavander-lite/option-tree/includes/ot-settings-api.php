  ...
  class OT_Settings {
    ...
    public function display_page() {
      ...
      foreach( (array) $this->options as $option ) {
		...
		<li>Ability to change fonts via theme options</li>
		<li>Premium support</li>		
		</ul>';
				echo '		<a class="buy-freya button" title = "Click to check out the Premium Version" href ="https://themeforest.net/item/lavander-a-lifestyle-responsive-wordpress-blog-theme/20140677?ref=premiumtemplates" target = "_blank">Buy premium version of LAVANDER now !</a>';
				echo '</div>';
              ...
              echo '<div id="option-tree-header-wrap">';
                echo '<ul id="option-tree-header">';
                  ...
                  echo '<li id="option-tree-version"><span>' . $theme->get( 'Name' ) . ' '. esc_attr__('Version: ','lavander') . $theme->get( 'Version' ).'</span></li>';
