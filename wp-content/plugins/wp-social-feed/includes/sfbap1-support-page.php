...
<div id="container" style="width: 35%;float: left;">
        <div id="upc_contact-form" class="clearfix" style="width:320px;line-height: 1.5">
            <h1 style="margin: 6px;">Documentation</h1>
            <h2>If you need any help to get to know the Social Feed Plugin, Please Click the link below to see documentation</h2>
            <a style="font-size: 24px" target="_blank" href="https://www.arrowplugins.com/social-feed/docs/">See Documentation</a>
