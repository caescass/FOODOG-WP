...
$sfbap1_facebook_access_token = get_post_meta($id, '_sfbap1_facebook_access_token', true);
...
$sfbap1_social_card_width = get_post_meta($id, '_sfbap1_social_card_width', true);
$sfbap1_social_card_background_color = get_post_meta($id, '_sfbap1_social_card_background_color', true);
$sfbap1_heading_font_size = get_post_meta($id, '_sfbap1_heading_font_size', true);
$sfbap1_caption_font_size = get_post_meta($id, '_sfbap1_caption_font_size', true);
$sfbap1_social_card_heading_color = get_post_meta($id, '_sfbap1_social_card_heading_color', true);
$sfbap1_social_card_content_color = get_post_meta($id, '_sfbap1_social_card_content_color', true);
$sfbap1_social_card_date_color = get_post_meta($id, '_sfbap1_social_card_date_color', true);
$sfbap1_feed_profile_style = get_post_meta($id, '_sfbap1_feed_profile_style', true);
$sfbap1_hide_media = get_post_meta($id, '_sfbap1_hide_media', true);
...
<?php if($sfbap1_feed_profile_style == 'square'){?> 
    border-radius: 0 !important;
<?php } ?>
<?php if($sfbap1_feed_profile_style == 'rounded'){?> 
    border-radius: 50% !important;
<?php } ?>
<?php if($sfbap1_feed_profile_style == 'curved'){?> 
...
background: <?php echo $sfbap1_social_card_background_color; ?> !important;
...
.social-feed-container-<?php echo $id; ?> .author-title{
    <?php if($sfbap1_social_card_heading_color != ''){?> 
color: <?php echo $sfbap1_social_card_heading_color; ?> !important;
    <?php } ?>
...
.social-feed-container-<?php echo $id; ?> {
<?php if($sfbap1_social_card_width != ''){?> 
width: <?php echo $sfbap1_social_card_width; ?>px !important;
    <?php } ?>
...
<?php if($sfbap1_feed_style == 'vertical' && $sfbap1_theme_selection == 'template0'){?> 
	.social-feed-container-<?php echo $id; ?> .author-title{
        <?php if($sfbap1_heading_font_size != ''){?> 
font-size: <?php echo $sfbap1_heading_font_size; ?>px !important;
    <?php } ?>
        <?php if($sfbap1_social_card_heading_color != ''){?> 
color: <?php echo $sfbap1_social_card_heading_color; ?> !important;
    <?php } ?>
...
.social-feed-container-<?php echo $id; ?> .social-feed-element p.social-feed-text{
     <?php if($sfbap1_caption_font_size != ''){?> 
font-size: <?php echo $sfbap1_caption_font_size; ?>px !important;
    <?php } ?>
         <?php if($sfbap1_social_card_content_color != ''){?> 
color: <?php echo $sfbap1_social_card_content_color; ?> !important;
    <?php } ?>
color: white !important;
}.social-feed-container-<?php echo $id; ?> .pull-right{
float: right !important;
...
<?php	} } ?>
.social-feed-container-<?php echo $id; ?> .pull-right{
        <?php if($sfbap1_social_card_date_color != ''){?> 
color: <?php echo $sfbap1_social_card_date_color; ?> !important;
    <?php } ?>
}
</style>
...
var sfbap1_facebook_access_token = '<?php echo $sfbap1_facebook_access_token; ?>';
