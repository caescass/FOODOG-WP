...
if ( isset( $_REQUEST['sfbap1_enable_rss_feed'] ) ) {
	...
	if ( isset( $_POST['sfbap1_facebook_page_id'] ) ) {
		...
		if ( isset( $_POST['sfbap1_facebook_access_token'] ) ) {
		update_post_meta( $post_id, '_sfbap1_facebook_access_token', sanitize_text_field( $_POST['sfbap1_facebook_access_token'] ) );
	}
...
if ( isset( $_POST['sfbap1_social_card_width'] ) ) {
		update_post_meta( $post_id, '_sfbap1_social_card_width', sanitize_text_field( $_POST['sfbap1_social_card_width'] ) );
	}

	if ( isset( $_POST['sfbap1_social_card_background_color'] ) ) {
		update_post_meta( $post_id, '_sfbap1_social_card_background_color', sanitize_text_field( $_POST['sfbap1_social_card_background_color'] ) );
	}

	if ( isset( $_POST['sfbap1_heading_font_size'] ) ) {
		update_post_meta( $post_id, '_sfbap1_heading_font_size', sanitize_text_field( $_POST['sfbap1_heading_font_size'] ) );
	}

	if ( isset( $_POST['sfbap1_caption_font_size'] ) ) {
		update_post_meta( $post_id, '_sfbap1_caption_font_size', sanitize_text_field( $_POST['sfbap1_caption_font_size'] ) );
	}

	if ( isset( $_POST['sfbap1_social_card_heading_color'] ) ) {
		update_post_meta( $post_id, '_sfbap1_social_card_heading_color', sanitize_text_field( $_POST['sfbap1_social_card_heading_color'] ) );
	}

	if ( isset( $_POST['sfbap1_social_card_content_color'] ) ) {
		update_post_meta( $post_id, '_sfbap1_social_card_content_color', sanitize_text_field( $_POST['sfbap1_social_card_content_color'] ) );
	}

	if ( isset( $_POST['sfbap1_social_card_date_color'] ) ) {
		update_post_meta( $post_id, '_sfbap1_social_card_date_color', sanitize_text_field( $_POST['sfbap1_social_card_date_color'] ) );
	}
if ( isset( $_POST['sfbap1_feed_profile_style'] ) ) {
		update_post_meta( $post_id, '_sfbap1_feed_profile_style', sanitize_text_field( $_POST['sfbap1_feed_profile_style'] ) );
	}
	if ( isset( $_REQUEST['sfbap1_hide_media'] ) ) {
		update_post_meta($post_id, '_sfbap1_hide_media', TRUE);
	} else {
		update_post_meta($post_id, '_sfbap1_hide_media', FALSE);
	}
}