...
add_action('admin_menu', 'sfbap1_custom_plugins_pages');
add_action('admin_menu', 'sfbap1_rate_us_pages');
...
add_submenu_page(
    ...
    'Rate us',
    'manage_options',
    'sfbap1_rate_us_plugins',
    'sfbap1_rate_us_page' );

}


function sfbap1_rate_us_page(){
    include_once( 'sfbap1-rate-us.php' );
}


function sfbap1_custom_plugins_pages() {
...
function sfbap1_plugins_page(){
    include_once( 'sfbap1-our-plugins.php' );
}
